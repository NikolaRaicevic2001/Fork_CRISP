...
solver.set_hyper_parameters("maxIterations", np.array([5000]))              # maximum number of iterations for the outer loop
...
solver.set_hyper_parameters("muMax", np.array([1e12]))                      # maximum penalty parameter
