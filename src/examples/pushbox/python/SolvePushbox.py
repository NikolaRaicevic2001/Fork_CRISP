...
solver.set_hyper_parameters("trustRegionTol", np.array([1e-6]))
solver.set_hyper_parameters("constraintTol", np.array([1e-6]))
solver.set_hyper_parameters("trailTol", np.array([1e-6]))
