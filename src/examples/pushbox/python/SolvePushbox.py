...
solver.set_hyper_parameters("trailTol", np.array([1e-4]))                   # tolerance for the outer iterations
solver.set_hyper_parameters("trustRegionTol", np.array([1e-4]))             # tolerance for the trust region
